...
public class RegisterTest extends TestBase {
    ...
    private static final String DAY_OF_BIRTH = RandomData.getRandomDayOfBirth();
    private static final String MONTH_OF_BIRTH = RandomData.getRandomMonthOfBirth();
    ...
    public void register() throws InterruptedException {
        ...
        Assert.assertTrue(myAccountPage.isMyInfoAccountDisplayed(), "My Account heading didn't display");
    }
